 ...
 */
export async function extractFocused(page) {
    const script = `
    (() => {
 ...
 */
export async function extractButtons(page, config = {}) {
 ...
 */
export async function extractLinks(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractInputs(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractForms(page, config = {}) {
 ...
 */
export async function extractToggles(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractAlerts(page, config = {}) {
    const { limit = 5, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractModals(page, config = {}) {
 ...
 */
export async function extractErrors(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractLandmarks(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractTabs(page, config = {}) {
    const { limit = 5, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
 ...
 */
export async function extractHeadings(page, config = {}) {
    const { limit = 10, includeHidden = false } = config;
    const script = `
    (() => {
      ${GENERATE_SELECTOR_FN}
...
//# sourceMappingURL=page-extractors.js.map