...
describe('Cherry Chrome MCP Server', () => {
    ...
    it('should have all 21 tools defined', () => {
        ...
        assert.strictEqual(expectedTools.length, 21, 'Should have 21 tools total (5 chrome + 5 dom + 11 debugger)');
        // Verify categories
    ...
    it('should have correct config values', async () => {
        const { MAX_RESULT_SIZE, MAX_DOM_DEPTH, HARD_MAX_DOM_DEPTH } = await import('../src/config.js');
