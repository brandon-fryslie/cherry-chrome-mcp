...
import { extractFocused, extractButtons, extractLinks, extractInputs, extractForms, extractToggles, extractAlerts, extractModals, extractLandmarks, extractTabs, extractHeadings, } from '../src/tools/page-extractors.js';
...
describe('Page Extractors', () => {
    ...
    describe('extractButtons', () => {
        it('should extract button information', async () => {
            ...
            const btn1 = result.items.find((b) => b.selector.includes('btn1'));
    ...
    describe('extractLinks', () => {
        it('should extract link information', async () => {
            ...
            const homeLink = result.items.find((l) => l.text === 'Home');
    ...
    describe('extractInputs', () => {
        it('should extract input information', async () => {
            ...
            const nameInput = result.items.find((i) => i.id === 'name');
    ...
    describe('extractLandmarks', () => {
        it('should extract landmark information', async () => {
            ...
            const types = result.items.map((l) => l.type);
    ...
    describe('extractHeadings', () => {
        it('should extract heading information', async () => {
            ...
            const h1 = result.items.find((h) => h.level === 1);
...
//# sourceMappingURL=page-extractors.test.js.map