...
echo ""
echo "=========================================="
echo "Testing LEGACY MODE (USE_SMART_TOOLS=false)"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "Testing SMART MODE (USE_SMART_TOOLS=true)"
echo "=========================================="
echo ""

# Start server in smart mode and send a ListTools request
echo '{"jsonrpc": "2.0", "id": 1, "method": "tools/list"}' | USE_SMART_TOOLS=true node build/src/index.js 2>&1 | head -20 &
SMART_PID=$!
sleep 2
...
echo "  - Smart mode: [MODE: SMART TOOLS]"
